...
<body class="min-h-screen bg-rose-50 font-['Plus_Jakarta_Sans'] flex items-center justify-center p-6">
    <div class="bg-white rounded-3xl shadow-xl p-10 max-w-md w-full text-center border border-rose-100">
        ...
        <h1 class="text-2xl font-black text-[#7a2137]">Dashboard Kader</h1>
        <p class="text-gray-500 text-sm mt-2">Selamat datang, <strong>{{ Auth::user()->name }}</strong>!</p>
        <p class="text-gray-400 text-xs mt-1">Dashboard kader sedang dalam pengembangan.</p>
