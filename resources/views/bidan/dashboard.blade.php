...
<head>
    ...
    <title>Dashboard Bidan - Prevanta</title>
...
<body class="min-h-screen bg-rose-50 font-['Plus_Jakarta_Sans'] flex items-center justify-center p-6">
    <div class="bg-white rounded-3xl shadow-xl p-10 max-w-md w-full text-center border border-rose-100">
        ...
        <h1 class="text-2xl font-black text-[#7a2137]">Selamat datang, Ibu Bidan {{ Auth::user()->nama }}!</h1>
        <p class="text-gray-500 text-sm mt-2">Halaman <strong>Dashboard Bidan</strong> sedang dalam pengembangan.</p>
        <p class="text-gray-400 text-xs mt-1">Segera hadir — panel verifikasi & evaluasi medis balita posyandu.</p>
